...
- (void)viewDidLoad {
    ...
    CreditCardNoTxt.textAlignment=NSTextAlignmentLeft;
    CreditCardNoTxt.returnKeyType = UIReturnKeyNext;
    CreditCardNoTxt.keyboardType=UIKeyboardTypeEmailAddress;
    [CreditCardNoTxt setAutocorrectionType:UITextAutocorrectionTypeNo];
    CreditCardNoTxt.font=[UIFont fontWithName:@"Roboto-Regular" size:15];
    CreditCardNoTxt.autocapitalizationType=UITextAutocapitalizationTypeWords;
    CreditCardNoTxt.placeholder=@"Credit Card No";
    [CreditCardNoTxt setBackgroundColor:[UIColor clearColor]];
    ...
    YearTxt.textAlignment=NSTextAlignmentLeft;
    YearTxt.returnKeyType = UIReturnKeyNext;
    YearTxt.keyboardType=UIKeyboardTypeEmailAddress;
    [YearTxt setAutocorrectionType:UITextAutocorrectionTypeNo];
    YearTxt.font=[UIFont fontWithName:@"Roboto-Regular" size:15];
    YearTxt.autocapitalizationType=UITextAutocapitalizationTypeWords;
    YearTxt.placeholder=@"Exp Month           Exp Year           CCV";
    [YearTxt setBackgroundColor:[UIColor clearColor]];
    
    [mainView addSubview:YearTxt];
    ...
    AddLineTxt.placeholder=@"Billing Address Line 1";
    ...
    AddLine2Txt.placeholder=@"Billing Address Line 2";
    ...
    [AddToCartBtn setTitle:@"ADD CARD" forState:UIControlStateNormal];
...
-(void)animateTextField:(UITextField*)textField up:(BOOL)up
{
    ...
    if (self.view.frame.size.height==568) {
        ...
        if (textField.tag==9){
            ...
            movementDistance = -90;      // tweak as needed
            movementDuration = 0.3f;     // tweak as needed
        }
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    if (textField==FirstNameTxt) {
        ...
        [CreditCardNoTxt becomeFirstResponder];
    }
    else if (textField==CreditCardNoTxt) {
...
-(BOOL)loginValidation{
    ...
    if (CreditCardNoTxt.text.length<1)
    {
        UIAlertView *alertview=[[UIAlertView alloc]initWithTitle:@"Message"message:@ "Please enter your Credit Card No" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc] initWithTitle:@"Message" message:@"Please select your EXP Month /Year"  delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
        [alert show];
        return NO;
    }
